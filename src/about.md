...
サブスクリプションの費用を払うだけで、サービス提供会社が継続的に改善してくれるようなXaaS(IaaS/PaaS/SaaSなど)と異なり、オーダーメイドのソフトウェアでは、常に自社で改善をコントロールしていく必要があり、多くの場合必要なリソースを確保することができなくなります。

サービス事業会社は、自社のビジネスとして複数の顧客のために事業改善を行いますが、自社開発ではコストとみなされ、継続的な改善の費用が捻出できなくなるからです。そのため、長期的には改善速度が遅くなってしまいます。

つまり、誰かにとっての「攻めのIT領域」であるSaaS事業を守りとして活用することで効率よくIT活用することができるのです。
...
たとえば、全く内製の開発人員がいなく、採用を進めている最中であるなら、パートナーとともにノウハウを蓄積しながら開発する方法もあります。

たとえば、守りの領域にも関わらず、SaaS化が進んでいないような領域でのシステム開発をする場合には、競合他社と手を組んだり、できるかぎりクラウドサービスと連携しながらつくるといった手段もあります。
